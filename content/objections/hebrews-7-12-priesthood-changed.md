---
title: "Hebrews 7:12 — \"The Priesthood Changed, So the Law Changed\""
excerpt: "Hebrews says a change of priesthood means a change of law. Doesn't that mean Torah is obsolete?"
objection: "Hebrews 7:12 says 'when the priesthood is changed, the law must be changed also.' If the priesthood shifted from Levitical to Melchizedek, then the entire Torah has been changed or replaced. This is Scripture explicitly saying the law has been altered."
quick_answer: "The 'law' being changed is the specific regulation governing who may serve as priest — the tribal requirement that priests come from Levi. Yeshua is from Judah, so that one regulation shifts. The author of Hebrews confirms this in verse 18 by narrowing it to 'a former commandment' (singular) — not the Torah as a whole."
key_points:
  - "The Greek metatithemi ('changed/transferred') and the context point to a specific legal adjustment — the tribal eligibility requirement for the priesthood — not a wholesale replacement of Torah."
  - "Verse 18 narrows the scope explicitly: 'a former commandment' (entoles, singular) is set aside because of its weakness. One regulation, not 613 commandments."
  - "The New Covenant in Jeremiah 31:33 — which Hebrews itself quotes — promises to write the same Torah on the heart. If Torah were abolished, there would be nothing left to write."
  - "The Melchizedek priesthood predates the Levitical order (Genesis 14). This is restoration of an older pattern, not invention of a lawless one."
category: arguments
topic: covenant
tags: [hebrews, priesthood, melchizedek, greek-grammar, torah-continuity]
difficulty: intermediate
date: 2026-04-19
related: [hebrews-8-13-obsolete-covenant, galatians-paul-abolished-law]
---
...
This is fulfillment, not abolition — the same principle Yeshua states in [Matthew 5:17-19](/articles/matthew-5-17-19-foundation). The arrow reaches its target. That does not mean the archer discards the bow — it means the purpose has been accomplished at a higher level.
