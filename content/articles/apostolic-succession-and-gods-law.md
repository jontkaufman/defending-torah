---
title: "Apostolic Succession and the Power to Change God's Law"
excerpt: "If an unbroken chain of bishops carries Christ's authority, can that authority move the Sabbath, retire the dietary laws, or define new doctrine? The Tanakh built its own successions — and they answer the question decisively."
category: arguments
...
1. **Transmission** — authority passes down an unbroken line of ordination.
2. **Alteration** — that transmitted authority includes the power to modify binding practice: to move the Sabbath, retire a command, define a new dogma.
...
**Essential**
- [Matthew 5:17–19 — The Text Nobody Preaches](/articles/matthew-5-17-19-foundation) — no institution is granted power to relax the least command.
- [One Law, Three Names — Moses, God, and Christ](/articles/one-law-moses-god-christ) — the law no office may rewrite is one law, named three ways.

**Recommended**
- [The Moral, Ceremonial, and Civil Division](/articles/moral-ceremonial-civil-division) — the other framework used to license selective change.
- [The Sabbath from Creation to Eternity](/articles/sabbath-creation-to-eternity) — the specific command the alteration claim is most often used to move.
