...
export function Footer() {
  return (
    <footer className="relative z-[1] px-10 pt-[60px] pb-[30px] max-md:px-6 max-md:pt-10 max-md:pb-5">
      ...
      <div className="grid grid-cols-[2fr_1fr_1fr] gap-[50px] mb-[50px] max-md:grid-cols-[1fr_1fr] max-md:gap-[30px]">
        {/* Brand */}
        <div>
      ...
      {/* Bottom */}
      <div className="pt-6 border-t border-ink flex justify-between items-center font-mono text-[10px] tracking-[0.22em] uppercase text-muted">
        ...
        <div>Set in Frank Ruhl Libre &amp; Cormorant</div>
      </div>
    </footer>
  );
}
